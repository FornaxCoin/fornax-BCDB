...
const transactionQuery = gql`
    extend type Query {
        ...
        transactionsByAddressWithPagination(page: Int, limit: Int, address:String!, sortBy:Sort): TransactionPaginator!,
        transactionsOf14Days: [RecordedTransaction],
        transactionsByMonth(address:String!): [RecordAccountTransaction],
    },
